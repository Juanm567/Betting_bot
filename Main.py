...
# Decision logic
#if power_diff <= 7:
    #print("Very close game\n Displaying win chances:")
    #team1_win = team1_total / (team1_total + team2_total)#Divide the part by the whole
    #team2_win = team2_total / (team1_total + team2_total)
    #print(f"Team 1 win chance:{team1_win:.2%}")
    #print(f"Team 1 win chance:{team2_win:.2%}")
